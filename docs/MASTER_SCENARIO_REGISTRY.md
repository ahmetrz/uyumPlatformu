...
| `PRT-OZT-002` | /tesisler/[id] | tesis sorumlusu · kendi tesisi | Tesis kimliği geçerli · normal | Tesis detayını açar | Varlık, uyum, risk ve olay özetleri birlikte görünür | Fotoğrafı olmayan tesis tipografik karşılık alır | yazma yok | yok | `plant360-profil.test.ts` |
