...
| `SIS-SNG-001` | /giris | ilk kez gelen ziyaretçi · giriş deneyimi | Hareketli giriş kullanılabilir · ileri ve geri kaydırma | Aynı ilerleme noktasına ileri ve geri yönden ulaşılır | Poz aynıdır; oda açıldıktan sonra ekrana yaklaşılır; kamera ekranın önünde kalır; DOM ve 3B izdüşümü eşleşir | Görsel süreklilik ayrıca tarayıcıda doğrulanmalıdır | yazma yok | yok | `giris-zaman.test.ts` · `giris-zaman.test.ts` · `giris-zaman.test.ts` · `giris-zaman.test.ts` · `giris-zaman.test.ts` |
