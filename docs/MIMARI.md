...
tabloları veritabanı tetikleyicileriyle UPDATE/DELETE'e kapalıdır. Sağlayıcı
SQLite'tır; Postgres'e geçişte yalnız datasource değişir
([POSTGRES_READINESS.md](POSTGRES_READINESS.md)).
