...
| --- | --- |
| Senaryo | 423 |
| Testi olan senaryo | 423 |
| **GAP** | **0** |
| Hayalet işaret (kütükte olmayan kimlik) | 0 |
| Kütüksüz test dosyası | 0 |
| Taranan test dosyası | 260 |
...
| `SIS-MRC-001` | Sistem | UI | `bekci/mercek-tasmasi.test.ts` | envanter taşma merceklerini birincillerle AYNI döngüde | evet | geçti |
