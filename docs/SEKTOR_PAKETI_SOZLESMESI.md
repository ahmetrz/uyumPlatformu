...
| 5 | **Yükümlülükler ve süreleri** | `yukumlulukler.json` — kod, ad, regülasyon, asgari şiddet, süre (saat, **boş bırakılabilir**), dayanak, merci, kanal notu, alan şablonu | **VAR** · `BildirimYukumlulugu(kod, ad, regulasyonId?, asgariSiddet, sureSaat?, dayanak, merci, kanalNotu?, alanSablonuJson?, aktif)` | Süre birimi saat sabit; gün/iş günü paket beyan etmeli (`sureBirimi`) |
