...
| **Kurulu sürüm değişmez** | SemVer sürümü değişmezdir: içerik değiştiyse numara yükselir; aynı numarayla farklı içerik kurulamaz | **Var (9 Eyl 2026, URN-PKT-008):** sürüm kaydı `ozetJson` taşır; aynı `surum` ile özetleri farklı paket SÜRÜM hatasıyla reddedilir, kayıt ve içerik olduğu gibi kalır; aynı özetlerle yeniden kurulum idempotent. Bağımlılık kararı da transaction içinde (URN-PKT-007) |
