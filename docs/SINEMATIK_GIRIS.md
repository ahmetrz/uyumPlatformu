# Sinematik giriş · v4 görsel yönetim
...
Tempo seçimi: Sakin 1,35×, Dengeli 1×, Hızlı 0,72× kaydırma mesafesi. Değişim sırasında mevcut kamera konumu korunur. Otomatik oynatma ve durunca devam eden hareket yoktur. Azaltılmış harekette statik giriş kullanılır.

Tamamlanınca sahne bütün alt öğeleriyle gizlenir ve tıklama hedefi olmaktan çıkar; gerçek arayüz normal akışı devralır. Yeni sürüm v5 oturum anahtarını kullanır.

Doğrulama: mevcut kamera/geometri testleri; tarayıcı kapısında iki genişlikte altlığın tam opaklığı, durma/geri kaydırma, tempo değişiminde konum, tamamlanınca gerçek form tıklaması. İnceleme kareleri CI'da alınır. Sayısal testlerin geçmesi görsel kalite iddiası değildir.
