...
> **TARİHSEL KAYIT — güncellenmez.** Bu denetim 2 Eylül 2026'da, ürün
> hâlâ ÜÇ KABUKTAN (A tezgâh · B saha · C defter) oluşurken yapıldı ve
> tek kabuğa geçişin gerekçesini kurdu. Buradaki her ölçüm o günün
> ürününe aittir; bugünkü ürünle karşılaştırmak için değil, kararın
> NEDEN alındığını okumak için durur. Bugünkü durum
> `docs/END_USER_UX_AUDIT.md` içindedir.
>
> Belge, `tasarim/ux-denetim-2026-09` dalı silinmeden önce main'e
> alındı; kanıt dosyaları `docs/denetim-2026-09/` altındadır.
