...
/* O14 · Faz 2 iskelesi — içerik Faz 5'te gelecek.
  ...
  return (
    <main>
      <header style={{ padding: 'var(--sec-pad-top) var(--gutter-op) 0' }}>
        <p className="t-eyebrow" style={{ margin: '0 0 var(--s10)' }}>YEDEK & DR · HAZIRLIK</p>
        <h1 className="t-screen" style={{ margin: 0 }}>Yedekleme & kurtarma</h1>
      </header>
      <div style={{ padding: 'var(--s26) var(--gutter-op) var(--sec-pad-bot)' }}>
        <div style={{ background: 'var(--card)', border: 'var(--bw-strong) solid var(--hr2)',
          ...
          <p style={{ margin: 0, fontSize: 'var(--t-cell)', color: 'var(--i2)' }}>
            Bu ekran O14 olarak onaylandı; içeriği Faz 5&apos;te bağlanacak.
          </p>
        </div>
      </div>
    </main>
