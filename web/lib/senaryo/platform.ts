...
export const PLATFORM_SENARYOLARI_6: Senaryo[] = [
  ...
  },
  {
    ...
    rol: 'saha kullanıcısı', kapsam: 'tek santral',
  ...
  {
    id: 'SIS-UXD-001', alan: 'Sistem', rota: '—', eksen: 'arayuz',
    amac: 'Hiçbir ekranın UX denetiminden kaçmaması',
    rol: 'ürün ekibi', kapsam: 'kurum geneli',
    onkosul: 'Yeni bir ekran eklendi', veriHali: 'normal',
    eylem: 'Denetim belgesi rota envanteriyle karşılaştırılır',
    beklenenSonuc: 'Her ekranın kendi denetim bölümü var',
    beklenenEkran: 'Belge "hepsini denetledik" derken doğru söyler',
    beklenenIz: 'yazma yok', beklenenBildirim: 'yok',
    katmanlar: ['UI', 'DOMAIN'],
  },
  {
    id: 'SIS-UXD-002', alan: 'Sistem', rota: '—', eksen: 'arayuz',
    amac: 'Her UX bulgusunun önemi ve durumu olması',
    rol: 'ürün ekibi', kapsam: 'kurum geneli',
    onkosul: 'Denetimde bulgu var', veriHali: 'kısmi',
    eylem: 'Bulgu kimlikleri tabloyla karşılaştırılır',
    beklenenSonuc: 'Her kimlik P0–P3 ve açık/kapatıldı taşır',
    beklenenEkran: 'Önemsiz ya da durumsuz bulgu kalmaz',
    beklenenIz: 'yazma yok', beklenenBildirim: 'yok',
    katmanlar: ['UI', 'DOMAIN'],
  },
];
