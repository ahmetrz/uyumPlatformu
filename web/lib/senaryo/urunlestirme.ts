...
export const URUNLESTIRME_SENARYOLARI: Senaryo[] = [
  ...
  },
  {
    ...
    rol: 'ürünü sürdüren geliştirici', kapsam: 'depo geneli',
    onkosul: 'Ad geçici; kalıcı ad sonra verilecek — ad sekiz kod dosyasında düz metindi',
    veriHali: 'çelişen',
    eylem: 'Kaynak ağacında ürün adını düz metin olarak arar',
    beklenenSonuc: '`lib/marka.ts` dışında hiçbir `.ts`/`.tsx`/`.css` dosyasında ad geçmez; görünen her yüzey `MARKA_AD` okur',
    beklenenEkran: 'Sekme başlığı, kabuk sözcük markası, giriş ve hata ekranı aynı adı gösterir',
    beklenenIz: 'yazma yok', beklenenBildirim: 'yok',
    katmanlar: ['DOMAIN', 'UI'],
  },
];
