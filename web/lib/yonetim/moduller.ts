...
const MODUL_TANIMLARI: ModulTanimi[] = [
  ...
  { kod: 'operasyonelBirim', grup: 'organizasyon', ad: (x) => basHarf(x.birim.tekil), sinif: 'A', yer: 'konsol', hedefTipi: 'operasyonelBirim',
    ...
    alanlar: [
      ...
      /* BİRİM AYRI ALANDIR: etikete gömülemez (§0.5) — ölçülen nicelik
         sektöre göre değişir. Boş bırakılırsa sayı birimsiz yazılır. */
      { ad: 'kuruluGucBirimi', etiket: 'Birim', tip: 'metin',
        aciklama: 'ölçünün birimi — boşsa sayı birimsiz yazılır' },
  ...
  { kod: 'etkiDegerlendirmesi', grup: 'varlik', ad: 'Üretim etkisi değerlendirmesi', sinif: 'A',
    yer: 'mevcut_ekran', rota: '/envanter',
    aciklama: 'OT-08 · üretim kaybı, RTO/RPO, emniyet ve çevre etkisi. Sayı yazan değerlendirme GEREKÇE ister; hesaplanmamış kayıp `null` kalır ve toplamda sıfır diye görünmez.' },
