...
export type OlculmemisGosterimi = {
  /** `ozet` sayı + oran + güç + ilk adlar · `sayi` yalnız sayı + oran.
      Gücün BİRİMİ veriden gelir (`TesisOzellik.birim`); bir dönem burada
      elektrik birimi yazılıydı çünkü ekran onu koda gömüyordu. */
  gosterim: 'ozet' | 'sayi';
