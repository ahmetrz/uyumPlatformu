...
kurulamaz.
| `yukumlulukler.json` | JSON dizi | `kod · ad · regulasyonKod? · asgariSiddet · sureSaat?` (BOŞ = mevzuat süre belirlememiş; `0` reddedilir) `· dayanak · merci · kanalNotu?` (cümle, ADRES DEĞİL) `· alanSablonu?` |
