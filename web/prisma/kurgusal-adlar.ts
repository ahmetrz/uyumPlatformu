...
export const GERCEK_AD_BEYANLARI: GercekAdBeyani[] = [
  ...
  /* ── ADAPTÖRÜN BAĞLANMAYI HEDEFLEDİĞİ ÜRÜNLER ───────────────────────
     ...
     bahsettiğini söylemezse kurulum talimatı olmaktan çıkar. Adlar bu
     yüzden gerçektir ve tam bu yüzden beyan edilir.

     Ölçüldü (8 Eyl 2026): bekçi veritabanını okuyordu ve adaptör
     metinlerini GÖRMÜYORDU; yayımlanmış çıktıda Splunk · Qualys ·
     Rapid7 · Palo Alto · Fortinet beyansız duruyordu. Kusur adların
     gerçek olması değildi — meşrular; kusur SESSİZ geçmeleriydi. */
  { ad: 'Active Directory', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Microsoft Active Directory / LDAP — kamuya açık şema belgesi',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Microsoft Entra ID', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Microsoft Graph v1.0 — kamuya açık API belgesi',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Microsoft Graph', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Microsoft Graph v1.0 — kamuya açık API belgesi',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Palo Alto PAN-OS', alan: 'Adaptor.hedefUrunler',
    kaynak: 'PAN-OS XML API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Cisco IOS-XE', alan: 'Adaptor.hedefUrunler',
    kaynak: 'IOS-XE RESTCONF — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Fortinet FortiOS', alan: 'Adaptor.hedefUrunler',
    kaynak: 'FortiOS REST API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Microsoft Defender for Endpoint', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Defender for Endpoint API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'SentinelOne', alan: 'Adaptor.hedefUrunler',
    kaynak: 'SentinelOne API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Claroty CTD', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Claroty CTD API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Nozomi Guardian', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Nozomi Guardian API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Dragos', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Dragos Platform API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Tenable.ot', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Tenable.ot API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Forescout eyeInspect', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Forescout eyeInspect API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Splunk', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Splunk REST API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Microsoft Sentinel', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Log Analytics API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'IBM QRadar', alan: 'Adaptor.hedefUrunler',
    kaynak: 'QRadar Ariel API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Elastic', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Elasticsearch API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Commvault', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Commvault REST API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'NetBackup', alan: 'Adaptor.hedefUrunler',
    kaynak: 'NetBackup API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Acronis', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Acronis Cyber Protect API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Tenable.io', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Tenable.io API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Qualys', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Qualys VM API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
  { ad: 'Rapid7', alan: 'Adaptor.hedefUrunler',
    kaynak: 'Rapid7 InsightVM API — kamuya açık belge',
    gerekce: ENTEGRASYON_HEDEFI },
