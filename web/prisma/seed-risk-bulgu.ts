...
const RISKLER: RiskTanim[] = [
  {
    ...
    aciklama: 'Saha K ve Saha L HES için yedekleme koşusu var ancak geri yükleme testi kaydı yok. Yedeğin geri dönebildiği kanıtlanmamış; kesinti hâlinde kurtarma süresi öngörülemez.',
    kaynak: 'veri_kalitesi', tesis: 'SAHA-K-HES',
    ...
    sahip: 'kullanici.e', durum: 'islemde', islemTipi: 'azalt',
  ...
  },
  {
    ...
    sahip: 'kullanici.d', durum: 'islemde', islemTipi: 'azalt',
  ...
  },
  {
    ...
    maddeKod: 'EPDK-SYM-6.2.1', varlikEtiketi: 'SAHA-A3-SCADA-01',
  },
  {
    kod: 'RSK-2026-008',
    ...
    kaynak: 'denetim', tesis: 'SAHA-C-RES',
  ...
  },
  {
    ...
    kaynak: 'denetim', tesis: 'SAHA-D-RES',
    ...
    sahip: 'kullanici.c', durum: 'acik', islemTipi: null,
  ...
  },
  {
    ...
    kaynak: 'veri_kalitesi', tesis: 'SAHA-C-RES',
    ...
    sahip: 'kullanici.b', durum: 'islemde', islemTipi: 'azalt',
  ...
  /* Kabul edilmiş riskler — süreli ve onaylı; kütükte kuyruğa toplanır. */
  {
    ...
    sahip: 'kullanici.a', durum: 'kabul_edildi', islemTipi: 'kabul', kabulGun: 210,
  },
  {
    kod: 'RSK-2026-017',
    ...
    kaynak: 'manuel', tesis: 'SAHA-G-HES',
    ...
    sahip: 'kullanici.a', durum: 'kabul_edildi', islemTipi: 'kabul', kabulGun: 95,
  },
  ...
  /* Kapanmış risk — "Kapalı riskleri gör" boş durumunun karşılığı. */
  {
    ...
    sahip: 'kullanici.d', durum: 'kapali', islemTipi: 'azalt',
  },
];
...
const BULGULAR: BulguTanim[] = [
  {
    ...
    tesisKod: 'SAHA-A3', kaynak: 'ic_denetim', tespitGun: -75, hedefGun: -12,
    sorumlu: 'kullanici.e', kokNeden: 'Test ortamı tahsis edilmemiş',
    aksiyon: {
      baslik: 'İzole geri yükleme ortamı kur ve ilk testi çalıştır',
      durum: 'devam', sorumlu: 'kullanici.e', hedefGun: -12,
  ...
  },
  {
    ...
    tesisKod: 'SAHA-A3', kaynak: 'dis_denetim', tespitGun: -52, hedefGun: -3,
    sorumlu: 'kullanici.d', kokNeden: 'Sözleşmede oturum kaydı şartı yok',
    aksiyon: {
      baslik: 'Jump host üzerinden oturum kaydı zorunlu hâle getir',
      durum: 'devam', sorumlu: 'kullanici.d', hedefGun: -3,
  ...
  },
  {
    ...
    tesisKod: 'SAHA-D-RES', kaynak: 'ic_denetim', tespitGun: -40, hedefGun: 18,
    sorumlu: 'kullanici.c',
    aksiyon: {
      baslik: 'Geçit kural setini belgele ve onaya sun', durum: 'devam',
      sorumlu: 'kullanici.c', hedefGun: 18, dogrulama: 'bekliyor',
    },
  },
  {
    ...
    tesisKod: 'SAHA-A3', kaynak: 'oz_degerlendirme', tespitGun: -28, hedefGun: 34,
    sorumlu: 'kullanici.c', aksiyon: null,
  },
  {
    ...
    tesisKod: 'SAHA-C-RES', kaynak: 'dis_denetim', tespitGun: -66, hedefGun: 26,
    sorumlu: 'kullanici.d', kokNeden: 'Parola kasası OT tarafında konumlandırılmamış',
    aksiyon: {
      baslik: 'Servis hesaplarını kasaya al, 90 günlük rotasyon başlat',
      durum: 'devam', sorumlu: 'kullanici.d', hedefGun: 26, dogrulama: 'bekliyor',
    },
  },
  {
    ...
    aksiyon: {
      ...
      durum: 'devam', sorumlu: 'kullanici.d', hedefGun: 12, dogrulama: 'bekliyor',
    },
  },
  {
    ...
    tesisKod: 'SAHA-C-RES', kaynak: 'ic_denetim', tespitGun: -90, hedefGun: 55,
    sorumlu: 'kullanici.b',
    aksiyon: {
      baslik: 'OT log toplayıcıyı iki pilot sahaya kur', durum: 'devam',
      sorumlu: 'kullanici.b', hedefGun: 55, dogrulama: 'bekliyor',
    },
  },
  {
    ...
    tesisKod: 'SAHA-A2', kaynak: 'oz_degerlendirme', tespitGun: -22, hedefGun: 44,
    sorumlu: 'kullanici.e',
    aksiyon: {
      baslik: 'Mühendislik projelerini merkezî yedeğe dâhil et', durum: 'planlandi',
      sorumlu: 'kullanici.e', hedefGun: 44, dogrulama: 'gerekmez',
    },
  },
  {
    ...
    tesisKod: 'SAHA-D-RES', kaynak: 'oz_degerlendirme', tespitGun: -15, hedefGun: 70,
     ...
     taşır. Ekranın "doğrulama bekliyor" metriği bu üçlüden türer. */
  {
    ...
    tesisKod: 'SAHA-A3', kaynak: 'ic_denetim', tespitGun: -120, hedefGun: 8,
    sorumlu: 'kullanici.a',
    aksiyon: {
      baslik: 'Envanter senkronizasyonunu günlük çalışacak şekilde planla',
      durum: 'tamamlandi', sorumlu: 'kullanici.a', hedefGun: -6, dogrulama: 'bekliyor',
    },
  },
  {
    ...
    tesisKod: 'SAHA-A2', kaynak: 'oz_degerlendirme', tespitGun: -100, hedefGun: 20,
    sorumlu: 'kullanici.a',
    aksiyon: {
      baslik: 'Kritiklik kuralını tüm envantere uygula', durum: 'tamamlandi',
      sorumlu: 'kullanici.a', hedefGun: -10, dogrulama: 'bekliyor',
    },
  },
  {
    ...
    aksiyon: {
      ...
      sorumlu: 'kullanici.d', hedefGun: -20, dogrulama: 'bekliyor',
    },
  },
];
  ...
  for (const r of RISKLER) {
    ...
    const risk = await db.risk.create({
      data: {
        ...
        onaylayanId: r.islemTipi === 'kabul' ? K['kullanici.a']?.id ?? null : null,
        durum: r.durum,
      },
    });
    riskSayisi++;
