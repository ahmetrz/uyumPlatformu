...
describe('Kaydırma ile giriş', () => {
  it('ileri ve geri aynı kaydırma noktasında aynı pozu verir', () => {
  ...
  it('kamerayı son düzleme ulaşmadan tam ekran açıklığa taşır', () => {
    const son = poz(1);
  ...
  it('açıklık açılmadan önce katmanlar hizalanır; zaman çizgisi süreksizlik taşımaz', () => {
