...
describe('paket doğrulayıcı — biçim ve manifest [URN-PKT-001]', () => {
  it('temiz paket geçer ve sayıları sayar', () => {
    ...
    expect(s.sayilar).toEqual({ sozluk: 1, kapsamTurleri: 1, oznitelikler: 1, cerceveler: 1, maddeler: 3, yukumlulukler: 1, formlar: 0, raporlar: 0, roller: 0, eslemeler: 0, kurallar: 0 });
